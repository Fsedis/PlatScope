...
Экран делит сеты на три рабочих вида: выгодные для быстрого дособирания, готовые к продаже и полный список. Кандидат на быстрое дособирание требует не более двух видов недостающих деталей и не более трёх предметов суммарно. Стоимость покупки считается только при надёжных ценах всех недостающих деталей. Выгода сета сравнивает цену полного сета со стоимостью всех его деталей, поэтому уже принадлежащие игроку детали не считаются бесплатной прибылью.
...
Раздел «Аналитика» содержит вкладки «Сеты», «Реликвии», «Дукаты» и «Riven» и явные empty/error/LKG states.

- «Сеты» сначала показывают конкретное действие: сколько деталей не хватает, примерную стоимость покупки, цену сета и выгоду относительно продажи всех деталей. Полный состав скрыт в раскрываемом блоке.
