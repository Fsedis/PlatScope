...
describe("читаемость рабочего интерфейса", () => {
  ...
  it("не уменьшает подписи рабочих экранов ниже 12 px при базовых 16 px", () => {
    for (const filename of ["MarketOrderTable.svelte", "MarketOrderInsight.svelte", "MarketOffers.svelte", "MarketCreateOrder.svelte", "MarketTradeHistory.svelte", "AppSidebar.svelte", "MarketItemDetail.svelte", "MarketTradingShift.svelte", "BountyHunterScreen.svelte", "BountyJobDetail.svelte", "WorldActivityScreen.svelte", "PrimeResurgence.svelte", "OpportunityPlanner.svelte", "PlanSetDetail.svelte"]) {
