...
const standard: Record<MissionFilter, boolean> = {feather:true,pickup:true,decree_fragments:true,players:true,npc:false,other:true,goals:true,lootspots:false,dragon_doors:true,caches:true};
