...
//! guard instead вЂ” the same convention the single-flight scan lock already
...
#[allow(dead_code)] // Upstream helper retained verbatim for future scanner synchronization.
